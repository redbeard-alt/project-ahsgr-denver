...
```bash
make install
make build-dry   # verify index builds
make test        # run tests
make run         # start MCP server for openclaw
```

## OpenClaw Client

Slug: `ahsgr-north-denver` | Type: `nonprofit-chapter`

## Architecture

See `CLAUDE.md` for full module map and dev commands.
